...
| **3-septies** | [`goal-03-roteiros-e-linguagem.md`](goal-03-roteiros-e-linguagem.md) §7-octies | **O exercício da 1.2 sai do `.docx` e entra na página**: quadro com as três perguntas, prévia ao vivo e botão de copiar · rascunho em `localStorage` · medida de linha corrigida para 62ch | 🟡 aguardando validação |
