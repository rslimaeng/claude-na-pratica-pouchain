...
| 2 | — | M1: aulas 1.2 e 1.4 | ⏸️ |
| 3 | — | Hub M2 + aulas 2.1 · 2.2 · 2.3 | ⏸️ |
| 4 | — | M2: aulas 2.4 · 2.5 · 2.6 | ⏸️ |
| 5 | — | M2: aulas 2.7 · 2.8 | ⏸️ |
| 6 | — | Hub M3 + aulas 3.1 · 3.2 · 3.3 | ⏸️ |
| 7 | — | M3: aulas 3.4 · 3.5 · 3.6 | ⏸️ |
| 8 | — | Aula 3.7 + entregável final + plano de 30 dias | ⏸️ |
| 9 | — | `recursos/` + `kit-participante.zip` montado | ⏸️ |
...
2. **Auditoria** — matriz componente × `grep` × veredicto, contra os **8 gates** do `goal-01` §5
