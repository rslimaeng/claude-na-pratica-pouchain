...
| **4 · onda 27** | [`goal-04-skills-na-14.md`](goal-04-skills-na-14.md) | **A 1.4 vira a aula de fazer skill**: a situação deixa de ser tamanho e passa a ser mistura · anatomia da skill em 3 partes · a tela **Habilidades** reproduzida · a **vitrine** dos 3 níveis de carregamento · prompt salvo × skill · **a sua empresa já escreveu a skill** · o caminho dos 3 passos com prompt literal · skill × Project (verbo × substantivo) · o exemplo de 292 linhas · exercício ganha passo 5 e o módulo passa a ter **3 artefatos** · **o exercício sai do `.docx` e vira quadro preenchível** (o lugar aparece sozinho ao responder) · **pasta `exemplo/`** com o caminho dos 3 passos acontecendo · exercício vai de 4 para 7 passos · nascem **G20** a **G24**, e o **G6** é consertado · conserto de cópia em 2 páginas | ✅ aprovada e publicada em 08/08/2026 |
| **5 · onda 28** | [`goal-05-prova-e-mecanismo.md`](goal-05-prova-e-mecanismo.md) | **A prova do `/context` e o mecanismo da tranca**: entra a primeira imagem que é medição e não ilustração (43 skills em 0,4% da janela), recortada e comprimida em 85%, rolando dentro da caixa no celular · a legenda declara que a tela é do **terminal** e que o aluno não precisa dele · o conceito 2 ganha a tabela **lê? decide? o que acontece quando falha**, em `<table>` reaproveitado em vez de componente novo · **CAIXA ALTA não muda a regra de linha** · a pergunta que não separa nada · a direção de cena vai para o roteiro de palco · nasce o **G25** | ✅ publicada em 08/08/2026 |
| **6 · onda 29** | [`goal-06-capa-do-m2.md`](goal-06-capa-do-m2.md) | **A capa do M2, a auditoria e o deep dive de Cowork**: sai o vocabulário de onda da tela do cliente, o M1 deixa de dizer "em construção", M2 e M3 ganham nome de rotina, o `kit/LEIA-ME.md` sai do site e o `README` é reescrito para o cliente · nasce **`m2/index.html`** com seis aulas (a 1.4 absorveu quatro do plano de oito) e o bloco **dos três Claudes**, cortado por para-quem e com só o Cowork aceso · deep dive de 71 arquivos de Cowork, que corrige `Allow/Ask/Block` na taxonomia e responde a pendência da tarefa agendada · conserta o `<ul>` sem CSS no callout e o sangramento do fio, que já estava no ar no M1 | ✅ publicada em 08/08/2026 |
...
2. **Auditoria**, `python3 goals/gates.py` rodado da raiz. São 28 gates e 228 checagens, e o script sai com código 1 se alguma falhar
