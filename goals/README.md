...
| **3-undecies** | [`goal-03-roteiros-e-linguagem.md`](goal-03-roteiros-e-linguagem.md) §7-undecies | **O exercício da 1.3 sai do `.docx`** e vira quadro preenchível com contador e cópia · três blocos reenquadrados (momento-chave, card azul nas 4 aulas, tabela do gabarito) · nasce **G19** | 🟡 aguardando validação |
